...
<?php foreach ($show_detail_siswa as $dtl) : ?>
    <h2>id_siswa tabel siswa = <?php echo $dtl->id_siswa ?></h2>
<?php endforeach ?>
...
<?php foreach ($show_detail_pengajar as $detail) : ?>
    ...
    <h2>id_akun siswa = <?php echo $this->session->userdata('id_akun') ?></h2>

    <h2>id_akun pengajar = <?php echo $detail->id_akun ?></h2>

    <h2>id_pengajar tabel pengajar = <?php echo $detail->id_pengajar ?></h2>
                    ...
                    <div class="row my-5 pl-3 mx-0">
                        ...
                        <div class="row mt-5">
                            <div class="col-8">
                                ...
                                <?php } else { ?>
                                    <a class="" href="<?php echo base_url('auth/form_login/login'); ?>"><button type="button" class="btn text-white" style="border-radius: 10px; background-color: #27c499;">Pesan Les</button></a>
                                <?php } ?>
                            ...
                            <div class="col-4 cl-orange text-right">
                                ...
                                <!-- <a class="" href="whatsapp://send?text=Hello&phone=<?php echo $detail->no_hp ?>"><button type="button" class="btn text-" data-bs-toggle="modal" data-bs-target="#basicModal2" style="background-color: #fff; border: 1px solid #27c499; border-radius: 10px; color:#27c499; ">Chat</button></a> -->
                        ...
                        <div class="modal-content">
                            ...
                            <form action="<?= site_url('detail_pengajar/upload') ?>" method="post">
                                <div class="modal-body">
                                    ...
                                    <!-- <input type="hidden" name="id_siswa" value="<?php echo $this->session->userdata('id_akun') ?>"> -->
...
<!-- <?php if ($this->session->flashdata('success')) : ?>
    <script>
        swal("Berhasil di kirim", "Selamat pemesanan berhasil di kirim ", "success");
    </script>
<?php endif; ?> -->