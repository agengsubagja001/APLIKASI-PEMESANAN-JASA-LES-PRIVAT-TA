...
<main id="main" class="main">
    ...
    <section class="section">
        <form action="<?= base_url('siswa/pembayaran/upload_pembayaran'); ?>" method="post">
            <div class="row">
                <div class="col-xl-7">
                    <div class="card">
                        <div class="card-body pt-3" style="overflow-x:auto; padding: 0 50px 50px 50px;">
                            <h5 class="card-title">Masukan bukti upload pembayaran</h5>

                            <?php foreach ($show_pembayaran as $profil) : ?>

                                <div class="tab-pane fade show active profile-overview" id="profile-overview">

                                    <div class="row mb-3">
                                        <label for="Address" class="col-md-4 col-lg-3 col-form-label">Upload Bukti Pembayaran</label>
                ...
                <div class="col-xl-5">
                    <div class="card">
                        <div class="card-body pt-3" style="overflow-x:auto; padding: 0 50px 50px 50px;">
                            ...
                            <?php foreach ($val_siswa as $pjrval) : ?>
