    ...
    <div class="mx-auto d-flex flex-lg-row flex-column hero">
      ...
      <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
        ...
        <h2 class="title-text-big">
          Platfrom Jasa Les Private<br class="d-lg-block d-none" />
          dan pemesanan jasa Les Privat
        </h2>
        <div class="center d-flex flex-sm-row flex-column align-items-center mx-lg-0 mx-auto justify-content-center gap-3">
    ...
    <div class="row content">
      <div class="col-12 px-md-0 my-auto">
        ...
        <div class="headline mt-3">
          Pengejar <br class="d-none d-md-block">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <!-- alert data search ksosng -->
            <?php if (empty($show_datapengajar)) : ?>

              <div class="alert alert-danger text-center" role="alert">
                data pengajar kosong
              </div>
            <?php endif; ?>
            <!-- akhir alert -->
          </div>
        ...
        <div class="row benefits">
          <?php foreach ($show_datapengajar as $pjr) : ?>
            <div class="col-md-4 mt-md-0">
              <div class="card p-4" style="width: 20.25rem; border-radius: 28px; border: none !important; -webkit-box-shadow: 20px 8px 18px rgb(178 177 255 / 5%); box-shadow: 20px 8px 18px rgb(178 177 255 / 5%);">
                <img src="<?php echo base_url() . 'assets/foto_pengajar/' . $pjr->gambar ?>" alt="img-place" class="img-fluid img-place-header">
                <h3 class="mt-4 font-weight-bold">
                  <?php echo $pjr->nama_pengajar ?>
                </h3>
                <p class="mb-5">
                  <?php echo $pjr->bidang ?>
                </p>
                <div class="row">
                  <div class="col-8">
                    <a class="navbar-brand" href="<?php echo base_url() . 'detail_pengajar?id=' . $pjr->id_pengajar ?>"><button type="button" class="btn text-white" style="border-radius: 10px; background-color: #27c499;">Lihat Detail</button></a>
                  </div>
                  <div class="col-4 cl-orange text-right">
                    <!-- <strong>
                                            <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Header/Header-House/star-yellow.svg"
                    ...
                    <a class="navbar-brand" href="#" data-toggle="modal" data-target="#exampleModal"><button type="button" class="btn text-" style="background-color: #fff; border: 1px solid #27c499; border-radius: 10px; color:#27c499; ">Chat</button></a>
    ...
    <div class="value row mx-0 d-flex justify-content-center justify-content-md-between">
      <div class="card">
        <div class="card-body p-0">
          <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/dollar-sign.png" alt="dolar" class="img-fluid">
          <div class="card-desc">
      ...
      <div class="card">
        <div class="card-body p-0">
          <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/shield.png" alt="dolar" class="img-fluid">
          <div class="card-desc">
      ...
      <div class="card">
        <div class="card-body p-0">
          <img src="https://api.elements.buildwithangga.com/storage/files/2/assets/Content/Content10/cpu.png" alt="dolar" class="img-fluid">
          <div class="card-desc">
  ...
  <div class="footer-2-2 container-xxl mx-auto position-relative p-0" style="font-family: 'Poppins', sans-serif">
    ...
    <div class="border-color info-footer">
      ...
      <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
        ...
        <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center text-center">
