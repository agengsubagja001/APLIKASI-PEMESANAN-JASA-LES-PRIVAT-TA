            ...
            <table class="table datatable">
              <thead style="background: #f6f6fe;">
                <tr>
                  ...
                  <th scope="col">Bidang Les</th>
                  <!-- <th scope="col">Alamat</th> -->
                  <!-- <th scope="col">jam</th> -->
                  <!-- <th scope="col">hari</th> -->
                  <th scope="col">kontrak</th>
                  <th scope="col">Tanggal Les</th>
              ...
              <tbody>
                ...
                foreach ($show_request as $request) :  $datetime = date('Y, H:i-m-d', strtotime($request->create_ate));
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url() . 'pengajar/reviews/reviews_les/' . $request->id_pesanan ?>" class="mt-1 btn btn-dark btn-sm" title="Validasi Les Privat"><i class="bi bi-gear"></i></a>
...
<?php if ($this->session->flashdata('success')) : ?>
  <script>
    swal("Berhasil ", "Les Privat Berhasil Di Review!", "success");
  </script>
<?php endif; ?>
<!--akhir sweetalert -->
